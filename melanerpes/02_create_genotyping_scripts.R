...
directory_name <- "11_melanerpes_genotype"
reference_genome_location <- "/lustre/scratch/johruska/central_america_pine_oak/melanerpes_ref/c05_colaptes_arcs3.FINAL.reordered.fasta"
cluster <- "quanah"
output_name <- "melanerpes_genotype"
popmap <- "melanerpes_popmap.txt"
individuals <- read.table(popmap, sep="\t")
faidx <- read.table("c05_colaptes_arcs3.FINAL.reordered.fasta.fai", stringsAsFactors=F)
